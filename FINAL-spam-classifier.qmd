...
### Variable 1: Message has exclamation (yes or no)
...
```{r}
#Variable 1: Has Exclamation (yes or no)
...
### Variable 2: Word count of message

```{r}
#Variable 2: How many words the message has 
...
### Variable 3: Contains any of the top 10 words contained in spam

```{r}
#Variable 3: Contains any of the top 10 words contained in a spam message
...
### Variable 4: Sentiment of the message

```{r}
#Variable 4: Sentiment of the message (positive or negative)

spam_data <- 
  read.table(file = here("~/R/DS400/finalproj/SMSSpamCollection"), sep="\t", quote="", comment.char="") %>%
...
Predicting message type based on the 4 variables
